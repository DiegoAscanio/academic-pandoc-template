...
authors:
  - name: Eleanor Roosevelt
    ...
    email: eleanor.eoosevelt@domain.com
  ...
  - name: John Peters Humphrey
    orcid: 0009-0000-1234-5678
    email: jph@domain.com
...
csl: chicago-note-bibliography.csl # see https://www.zotero.org/styles for more styles, file path for typst, url or file path for all other formats
date: 1 January 2023
keywords: keyword1, keyword2 # list of keywords to be included in HTML, PDF, ODT, pptx, docx and AsciiDoc metadata; repeat as for author, above
lang: en-US
nocite: |
  @brown2016
subtitle: 'Subtitle'
...
indent: false # if true, pandoc will use document class settings for indentation (the default LaTeX template otherwise removes indentation and adds space between paragraphs)
...
secnumdepth: 2 # numbering depth for sections (with --number-sections option or numbersections variable)
...
fontsize: 12pt # font size for body text. The standard classes allow 10pt, 11pt, and 12pt. To use another size, set documentclass to one of the KOMA-Script classes, such as scrartcl or scrbook.
mainfont: ''
sansfont: ''
monofont: ''
mathfont: ''
...
# Word
category: paper # document category, included in docx and pptx metadata
description: description # document description, included in ODT, docx and pptx metadata. Some applications show this as Comments metadata.
